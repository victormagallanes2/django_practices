...
INSTALLED_APPS = [
    ...
    'django_practices.home',
    'django_practices.reports',
    'rest_framework',
    'django_practices.apis',
    'django_practices.crud',
    'django_practices.emails',
    'django_practices.chart',
    'django_practices.usercustom',
    'django_practices.inlineform',
    'extra_views',
    # django-registration-redux
    'django.contrib.sites',
    'corsheaders',
    'registration',
    'django_practices.settings.jwt_config',
    'rest_framework_jwt',
]
...
AUTHENTICATION_BACKENDS = (
    ...
    'django_practices.usercustom.backends.EmailAuthBackend'
)
...
JWT_AUTH = {
    'JWT_RESPONSE_PAYLOAD_HANDLER': 'django_practices.settings.jwt_config.views.jwt_response_payload_handler',
